...
export async function cityStateRoutes(app) {
    ...
    app.post('/suggest', async (request) => {
        ...
        const id = await cityStateService.suggestCityState(request.user.id, body.name, body.latitude, body.longitude, body.radius);
