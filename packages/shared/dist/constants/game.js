...
// Bastion mechanics
export const BASTION_MAX_HP = [50, 100, 200]; // per level (0, 1, 2)
export const BASTION_UPGRADE_CRYSTAL_COSTS = [0, 15, 50]; // crystals to reach level 0→1, 1→2
...
export const WORKER_UPGRADE_CRYSTAL_COSTS = [0, 5, 15]; // crystals to reach level 0→1, 1→2
export const BASTION_STORAGE_HERBS = [30, 60, 120];
export const BASTION_STORAGE_CRYSTALS = [10, 20, 40];
export const BASTION_STORAGE_RELICS = [5, 10, 20];
export const BASTION_STORAGE_SCOUTS = [3, 6, 12];
export const BASTION_WORKER_SLOTS = [2, 3, 4];
...
// Streak System
export const STREAK_BONUS_3 = { herbs: 5 };
export const STREAK_BONUS_7 = { crystals: 3 };
export const STREAK_BONUS_30 = { relics: 1 };
